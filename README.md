...
## Integração Banco de Dados com Sistema Python
 ...
 Destrinchando *'conexao'*:
 

    conexao  =  psycopg2.connect(host="127.0.0.1", database="senai", user="postgres", password="senai", port=5432)

psycopg2.connect = comando do banco 'postgres'
host = Onde o servidor roda, nesse caso (127.0.0.1), rodando localmente
database = Nome do Banco de Dados
user = Nome de usuário
password = Senha exemplo
port = Porta onde o banco de dados funciona, no caso de postgres, 5432, no caso de MYSQL 


    pip install psycopg2
    import  psycopg2

pip install pyscopg2 = importação de banco de dados do Postgres, deve ser usado no terminal*
import psycopg2 = importa uma biblioteca que conecta o python com o postgres
...
Em ordem: Cria um comando de query pra ser executado no mysql, cria uma consulta, printa os dados da tabela e finaliza fechando o banco de dados
